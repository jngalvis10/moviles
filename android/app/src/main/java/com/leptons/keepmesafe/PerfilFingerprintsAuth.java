...
public class PerfilFingerprintsAuth extends AppCompatActivity {
                ...
                new BottomNavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.mapa:
                                Intent intent = new Intent(PerfilFingerprintsAuth.this, Mapa.class);
                                startActivity(intent);
                                break;
                            case R.id.viaje:
                                Intent intent2 = new Intent(PerfilFingerprintsAuth.this,Viaje.class);
                                startActivity(intent2);
                                break;
                            case R.id.tracking:
                                Intent intent3 = new Intent(PerfilFingerprintsAuth.this, Tracking.class);
