...
public class Mapa extends FragmentActivity implements LocationListener,
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.mapa:
                                break;
                            case R.id.viaje:
                                Intent intent = new Intent(Mapa.this, Viaje.class);
                                startActivity(intent);
                                break;
                            case R.id.tracking:
                                Intent intent2 = new Intent(Mapa.this, Tracking.class);
                                startActivity(intent2);
                                break;
                            case R.id.perfil:
                                Intent intent3 = new Intent(Mapa.this, PerfilFingerprintsAuth.class);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(4.6030567, -74.0653067);
